...
enum gdb_regno {
	...
	/*[OS]: SweRV reg*/
	GDB_REGNO_MRAC     = CSR_MRAC     + GDB_REGNO_CSR0,   
    GDB_REGNO_MCPC     = CSR_MCPC     + GDB_REGNO_CSR0,   
    GDB_REGNO_DMST     = CSR_DMST     + GDB_REGNO_CSR0,    
    GDB_REGNO_MPMC     = CSR_MPMC     + GDB_REGNO_CSR0,
    GDB_REGNO_DICAWICS = CSR_DICAWICS + GDB_REGNO_CSR0, 
    GDB_REGNO_DICAD0   = CSR_DICAD0   + GDB_REGNO_CSR0, 
    GDB_REGNO_DICAD1   = CSR_DICAD1   + GDB_REGNO_CSR0, 
    GDB_REGNO_DICAGO   = CSR_DICAGO   + GDB_REGNO_CSR0, 
    GDB_REGNO_MGPMC    = CSR_MGPMC    + GDB_REGNO_CSR0, 
    GDB_REGNO_MICECT   = CSR_MICECT   + GDB_REGNO_CSR0, 
    GDB_REGNO_MICCMECT = CSR_MICCMECT + GDB_REGNO_CSR0, 
    GDB_REGNO_MDCCMECT = CSR_MDCCMECT + GDB_REGNO_CSR0, 
    GDB_REGNO_MCGC     = CSR_MCGC     + GDB_REGNO_CSR0, 
    GDB_REGNO_MFDC     = CSR_MFDC     + GDB_REGNO_CSR0, 
    GDB_REGNO_MDEAU    = CSR_MDEAU    + GDB_REGNO_CSR0, 
    GDB_REGNO_MDSEAC   = CSR_MDSEAC   + GDB_REGNO_CSR0, 
    GDB_REGNO_MEIPT    = CSR_MEIPT    + GDB_REGNO_CSR0, 
    GDB_REGNO_MEIVT    = CSR_MEIVT    + GDB_REGNO_CSR0, 
    GDB_REGNO_MEIHAP   = CSR_MEIHAP   + GDB_REGNO_CSR0, 
    GDB_REGNO_MEICPCT  = CSR_MEICPCT  + GDB_REGNO_CSR0, 
    GDB_REGNO_MEICIDPL = CSR_MEICIDPL + GDB_REGNO_CSR0, 
    GDB_REGNO_MEICURPL = CSR_MEICURPL + GDB_REGNO_CSR0, 
	/* end of SweRV csrs */
